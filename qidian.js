...
[Script]
http-request ^https\:\/\/h5\.if\.qidian\.com\/argus\/api\/v1\/video\/adv\/finishWatch script-path=https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/Scripts/myScripts/qidian/qidian.cookie.js,requires-body=true, timeout=10,enable = {CaptureCookie},tag=起点获取token
# 定时签到
https\:\/\/h5\.if\.qidian\.com\/argus\/api\/v1\/video\/adv\/mainPage script-path=https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/Scripts/myScripts/qidian/qidian.taskId.js,requires-body=true, timeout=10,enable = {CaptureCookie},tag=起点获取token
# 定时签到
[MITM]
